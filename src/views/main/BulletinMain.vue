    ...
    <div class="Main_div">
      ...
      <div class="main main_con">
        <div class="cut_off_btn">
          <button class="red_btn">차단</button>
          <button class="all_red">회원</button>
        </div>
        ...
        <tbody>
          <tr class="row import" v-for="(item, index) in topList" :key="index">
            ...
            <td class="tabel_view">{{item.date}}</td>
...
export default {
  ...
  data () {
    return {
      ...
      topList: [
        { number: '100', nickname: '와우', type: '일반', name: '정영교', phone_number: '010-1234-5496', date: '2023-03-15', login: '2023-03-15' },
        { number: '100', nickname: '와우', type: '일반', name: '정영교', phone_number: '010-1234-5496', date: '2023-03-15', login: '2023-03-15' },
        { number: '100', nickname: '와우', type: '일반', name: '정영교', phone_number: '010-1234-5496', date: '2023-03-15', login: '2023-03-15' },
        { number: '100', nickname: '와우', type: '일반', name: '정영교', phone_number: '010-1234-5496', date: '2023-03-15', login: '2023-03-15' },
        { number: '100', nickname: '와우', type: '일반', name: '정영교', phone_number: '010-1234-5496', date: '2023-03-15', login: '2023-03-15' },
